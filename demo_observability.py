...
from src.core.observability import get_metrics_summary, reset_metrics, span
from src.tools.monitor import MonitorIn, MonitorTool
...
def main():
    ...
    try:
        ...
        print(
            ...
            "las métricas se acumulan con el tiempo"
        )
